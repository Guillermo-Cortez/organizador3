...
@people = ['juan', 'andrea', 'leon', 'andres', 'natalia', 'camilo', 'rusbel', 'johan']

@people.each do |name|

    User.create email: "#{name}@gmail.com", password: 'platzi'
...
['conceptualización', 'Entorno de desarrollo de RoR', ['natalia:1', 'leon:2', 'andrea:random']],
...
['ejercicios', 'Crear una nueva aplicación RoR ¡Hola Rails!', ['natalia:1', 'leon:2', 'andrea:random']],
...
['desarrollo', 'Los secretos de rails', ['juan:1', 'natalia:2', 'andrea:random']],
...
['desarrollo', 'Esteroides para tu desarrollo - HAML', ['natalia:1', 'leon:2', 'andrea:random']],

['desarrollo', 'Esteroides para tu desarrollo - Simple Form', ['natalia:1', 'leon:2', 'andrea:random']],
...
['desarrollo', 'Agregar validaciones de modelo', ['juan:1', 'natalia:2', 'andrea:random']],

['desarrollo', 'Añadiendo el concepto de usuario', ['juan:1', 'leon:2', 'andrea:random']],

['desarrollo', 'Añadir participantes a la tarea', ['natalia:1', 'leon:2', 'andrea:random']],

['desarrollo', 'CanCanCan ¿puedes hacerlo?', ['juan:1', 'natalia:2', 'andrea:random']],
...
['conceptualización', 'Desplegando a Heroku', ['natalia:1', 'leon:2', 'andrea:random']],
